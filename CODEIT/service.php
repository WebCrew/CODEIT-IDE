...
function listFiles( $_pathDir )
{
	...
	foreach ($files as $record)
	{
		...
		{
?>
<li draggable="true" ondragover="codeit_app.fileBrowserPanel.onDragOverNode( event );" ondragleave="codeit_app.fileBrowserPanel.onDragLeaveNode( event );" ondragstart="codeit_app.fileBrowserPanel.onDragStartNode( event );" itemType="dir" class="collapsedNode unselectedNode" title="<? echo $record['path']?>" ondrop="codeit_app.fileBrowserPanel.onDropOnNode( event );" >
...
<?		
		...
		{
?>
<li draggable="true" ondragover="codeit_app.fileBrowserPanel.onDragOverNode( event );" ondragleave="codeit_app.fileBrowserPanel.onDragLeaveNode( event );" ondragstart="codeit_app.fileBrowserPanel.onDragStartNode( event );"  itemType="file" class="unselectedNode" title="<? echo $record['path']?>"  >
<a>&nbsp;</a><div class="treeViewItemIcon_<? echo $record['type']?>" ><? echo $record['name']?></div>
</li>
<?		
		}
