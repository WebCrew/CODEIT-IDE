						...
						<ul class="toolBar">
		    				...
		    				<li id="INFO_MENU_toolButton" class="unselectedToolButton"  title="" ><a></a>
			    				<ul  class="panel popupMenu"   >
					        		<li class="popupMenuItem" id="ABOUT_APP_menuItem"   title=""><? PrintSTR( 'About CODEIT...' ) ?></li>
		    				...
		    				<li id="CREATE_FILE_toolButton" class="unselectedToolButton"  title="" ><a></a>
			    				<ul  class="panel popupMenu"   >
					        		...
					        		<li class="popupMenuItem" id="CREATE_FILE_LESS_menuItem"  fileType="less" title=""><? PrintSTR( 'New file - LESS' ) ?></li>
					        		<li class="popupMenuItem" id="CREATE_FILE_MD_menuItem"  fileType="md" title=""><? PrintSTR( 'New file - MD' ) ?></li>
					        		<li class="popupMenuItem" id="CREATE_FILE_SQL_menuItem" fileType="sql"  title=""><? PrintSTR( 'New file - SQL' ) ?></li>
							        <div style="clear:both"></div>
					        	</ul>
		    				</li>
